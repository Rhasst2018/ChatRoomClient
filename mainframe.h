...
signals:
    ...
    void info_myofflne();
    void quit_qq();
    void get_sendipandport(QString myname,QString sendname,quint16 portt,QHostAddress addr,QString filename,qint64 filesize);//////获取ip和port
...
public slots:
    ...
    void get_sendip_port(QString myname,QString sendname,quint16 portt,QString filename,qint64 filesize);

    void show_receivefile(QString msg_from,QString myname,quint16 port,QHostAddress addr,QString filename,qint64 filesize);

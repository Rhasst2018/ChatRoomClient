    ...
    ui(new Ui::chat_face)
{
    ...
    /////这个部分是用来显示动态图片的部分///////////////
        ...
        QMovie *pm=new QMovie(":/new/picture/imqface/1.gif");
        ui->label->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/2.gif");
        ui->label_2->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/3.gif");
        ui->label_3->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/4.gif");
        ui->label_4->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/5.gif");
        ui->label_5->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/6.gif");
        ui->label_6->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/7.gif");
        ui->label_7->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/8.gif");
        ui->label_8->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/9.gif");
        ui->label_9->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/10.gif");
        ui->label_10->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/11.gif");
        ui->label_11->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/12.gif");
        ui->label_12->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/13.gif");
        ui->label_13->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/14.gif");
        ui->label_14->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/15.gif");
        ui->label_15->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/16.gif");
        ui->label_16->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/17.gif");
        ui->label_17->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/18.gif");
        ui->label_18->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/19.gif");
        ui->label_19->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/20.gif");
        ui->label_20->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/21.gif");
        ui->label_21->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/22.gif");
        ui->label_22->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/23.gif");
        ui->label_23->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/24.gif");
        ui->label_24->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/25.gif");
        ui->label_25->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/26.gif");
        ui->label_26->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/27.gif");
        ui->label_27->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/28.gif");
        ui->label_28->setMovie(pm);
        pm->start();

        pm=new QMovie(":/new/picture/imqface/29.gif");
